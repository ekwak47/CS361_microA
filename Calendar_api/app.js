...
app.use(express.static(path.join(__dirname, 'calendar_api')))
...
app.post('/events', (req, res) =>{
  ...
  // Check if busy and have an event on our calendar for the same time.
...
app.listen(4987, () =>{
  console.log('Server running on port 4987')
})